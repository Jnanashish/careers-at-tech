    ...
    return (
        <>
            ...
            <div className={styles.privacyContainer}>
                ...
                <p>
                    By accessing this website we assume you accept these terms and conditions. Do not continue to use CareersAt.Tech if you do not agree to take all of the terms and conditions stated
                    on this page.
                </p>
                <br />
                ...
                <p>
                    Unless otherwise stated, CareersAt.Tech and/or its licensors own the intellectual property rights for all material on CareersAt.Tech. All intellectual property rights are reserved.
                    You may access this from CareersAt.Tech for your own personal use subjected to restrictions set in these terms and conditions.
                </p>

                <p>
                    You must not:
                    <ul>
                        <li>Republish material from CareersAt.Tech</li>
                        <li>Sell, rent or sub-license material from CareersAt.Tech</li>
                        <li>Reproduce, duplicate or copy material from CareersAt.Tech</li>
                        <li>Redistribute content from CareersAt.Tech</li>
                    </ul>
                </p>
                <br />

                <p>
                    Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. CareersAt.Tech does not filter, edit, publish or
                    review Comments prior to their presence on the website. Comments do not reflect the views and opinions of CareersAt.Tech,its agents and/or affiliates. Comments reflect the views
                    and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, CareersAt.Tech shall not be liable for the Comments or for any liability,
                ...
                <p>
                    CareersAt.Tech reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and
                    Conditions.
                </p>
                ...
                <p>
                    You hereby grant CareersAt.Tech a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats
                    or media.
                </p>
                ...
                <p>
                    ...
                    organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of CareersAt.Tech; and (d) the link is
                ...
                <p>
                    If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to CareersAt.Tech. Please
                ...
                <p>
                    We shall not be held responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s)
