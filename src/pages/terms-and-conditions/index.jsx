...
function Terms() {
    return (
        <div className={styles.privacyContainer}>
            ...
            <p>
                These terms and conditions outline the rules and regulations for the use of careers
                at tech s Website, located at https://careersat.tech/.
            </p>

            <p>
                By accessing this website we assume you accept these terms and conditions. Do not
                continue to use Careers at tech if you do not agree to take all of the terms and
            ...
            <p>
                We employ the use of cookies. By accessing Careers at tech, you agreed to use
                cookies in agreement with the careers at tech s Privacy Policy.{" "}
            </p>
            ...
            <p>
                Unless otherwise stated, careers at tech and/or its licensors own the intellectual
                property rights for all material on Careers at tech. All intellectual property
                rights are reserved. You may access this from Careers at tech for your own personal
            ...
            <p>
                ...
                and information in certain areas of the website. careers at tech does not filter,
                edit, publish or review Comments prior to their presence on the website. Comments do
                not reflect the views and opinions of careers at tech,its agents and/or affiliates.
                Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, careers at tech shall not be
            ...
            <p>
                careers at tech reserves the right to monitor all Comments and to remove any
            ...
            <p>
                You hereby grant careers at tech a non-exclusive license to use, reproduce, edit and
            ...
            <p>
                ...
                careers at tech; and (d) the link is in the context of general resource information.
            </p>
            ...
            <p>
                ...
                in linking to our website, you must inform us by sending an e-mail to careers at
                tech. Please include your name, your organization name, contact information as well
            ...
            <p>
                No use of careers at tech s logo or other artwork will be allowed for linking absent
