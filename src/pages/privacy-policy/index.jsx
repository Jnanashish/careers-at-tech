    ...
    return (
        <div className={styles.privacyContainer}>
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Careers at tech, accessible from{" "}
                        <a href="https://careersat.tech/" rel="external nofollow noopener">
            ...
            <ul>
                <li>By phone number: 7743091193</li>
            </ul>
        </div>
    );
}
