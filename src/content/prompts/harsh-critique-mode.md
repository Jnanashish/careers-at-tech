---
title: "Get a brutally honest critique of my resume"
slug: "harsh-critique-mode"
category: "review-fixes"
categoryLabel: "Get reviewed and fix weaknesses"
description: "Most AI is too nice. This prompt forces it to tell you what's actually wrong with your resume."
forWho: "Freshers who've polished their resume and want the truth before sending it out"
timeMinutes: 3
difficulty: "Beginner"
worksWith: ["ChatGPT", "Claude", "Gemini"]
seoTitle: "Get a Brutally Honest Resume Critique | CareersAt.Tech"
seoDescription: "Free AI prompt that gives you a harsh, honest critique of your resume. No compliments, just what to fix. Built for Indian freshers."
featured: true
---
...
This prompt is for freshers who have already written and polished their resume and now want the truth about what is still wrong with it. Not encouragement. Not a pat on the back. A genuine, unfiltered critique.
...
CRITICAL:
- Professional summary uses "passionate and hardworking" — these are filler adjectives that add zero information. Recruiters skip them.
- Projects section has no metrics. "Built a web app" tells me nothing. What did it do? How many users? What was the tech decision?

MAJOR:
- Skills section lists 18 technologies. No fresher is proficient in 18 tools. This looks like keyword stuffing. Trim to 8-10 that you can actually discuss in an interview.
- Two bullet points start with "Responsible for." This is passive and weak. Start with what you built, not what you were responsible for.

MINOR:
- Dates use inconsistent formats ("Jan 2024" and "2024-01"). Pick one format.
- GitHub link is missing from contact section.
